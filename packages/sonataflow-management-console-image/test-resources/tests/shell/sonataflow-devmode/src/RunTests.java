...
public class RunTests {
    ...
    @Container
    private GenericContainer managementConsoleImage = new GenericContainer(getTestImage())
    ...
    public void testBuiltContainerAnswerCorrectly() throws URISyntaxException, IOException, InterruptedException {
        managementConsoleImage.start();
        HttpRequest request = HttpRequest.newBuilder()
                .uri(new URI(
                        "http://" + managementConsoleImage.getHost() + ":" + managementConsoleImage.getFirstMappedPort() + "/jsongreet"))
