...
export default function EditorPage() {
  ...
  const setContent = useCallback((normalizedPosixPathRelativeToTheWorkspaceRoot: string, content: string) => {
  ...
  return (
    <Page>
      {!editor && <PageSection isFilled={true}>No workflow loaded!</PageSection>}
